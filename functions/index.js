...
const app = express();
const port = 3000;
const api_key = 'RGAPI-a20a9e41-4a88-448b-ab94-20aef94eabac';
// const na
...
async function getPuuid(sName, sTag){
    const data = await fetch(`https://americas.api.riotgames.com/riot/account/v1/accounts/by-riot-id/${sName}/${sTag}?api_key=${api_key}`);
